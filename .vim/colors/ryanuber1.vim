...
hi PmenuSel		ctermfg=0		ctermbg=203						guifg=#000000	guibg=#cae682
endif


" Syntax highlighting
hi Keyword		ctermfg=210		cterm=none		guifg=#8ac6f2	gui=none
hi Statement	ctermfg=216		cterm=none		guifg=#8ac6f2	gui=none
